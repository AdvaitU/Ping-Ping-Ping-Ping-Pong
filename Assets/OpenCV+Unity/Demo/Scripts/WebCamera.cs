	...
	public abstract class WebCamera: MonoBehaviour
	{
		...
		public string DeviceName
		{
			...
			set
			{
				...
				if (-1 != cameraIndex)
				{
					cameraIndex = 1; // Forcing it to use a selected camera/webcam - 1 is the webcam that is connected, 0 is the inbuilt webcam.
		...
		protected virtual void Awake()
		{
            ...
            Debug.Log("Number of Webcams Connected: " + WebCamTexture.devices.Length);
        }
